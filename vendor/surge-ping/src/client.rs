...
use std::sync::atomic::AtomicU64 as RequestCounter;
#[cfg(not(target_has_atomic = "64"))]
use std::sync::atomic::AtomicU32 as RequestCounter;
...
impl Default for ReplyMap {
    fn default() -> Self {
        Self {
            ...
            next_id: Arc::new(RequestCounter::new(0)),
        }
    }
}
